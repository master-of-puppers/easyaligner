...
`easyaligner` is a forced alignment library for time-alignment of speech and text. Given a text transcript, `easyaligner` will help identify where each word or phrase was spoken in the audio.  

The library supports aligning from both ground-truth transcripts, as well as from ASR model outputs. 
...
They help target specific sections of the audio to be aligned, and preserve semantic structure and information for things like parliamentary speeches or audiobook chapters. 
:::
