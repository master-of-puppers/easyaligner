...
Before we move on to forced alignment, here's the text of the first chapter for reference. Note especially the paragraph breaks and punctuation. One of `easyaligner`'s main features is that it will retain the formatting of the original text after alignment. 
